...
const Phone2 = () => {
  return (
    <div className="flex flex-col md:flex-row text-white py-36 justify-between">
      <div>
        <div className="mx-4 md:mx-32 w-full md:w-11/12">
          <div className="font-bold text-2xl">PentHouse</div>
          <div className="text-xl">67 Mumbai India PIN 13774</div>
          <div className="w-full md:w-max">
            <img src="public/assets/houses/house1lg.png" alt="" />
          </div>
